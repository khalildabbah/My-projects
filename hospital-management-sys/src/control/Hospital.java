...
import model.IntensiveCareStaffMember;
...
public class Hospital implements Serializable {
	...
	public boolean addDoctorToDepartment(Department department,Doctor doctor) {
		...
		return write(department.addDoctor(doctor));
	}
	
	private boolean write(boolean result) {
		try {
	...
	public boolean addNurseToDepartment(Department department,Nurse nurse) {
		...
		if(!staffMembers.containsKey(nurse.getId())) {
			throw new ObjectDoesNotExist(nurse.getId(), nurse.getClass().getSimpleName(), this.getClass().getSimpleName());
				...
				return write(department.addNurse(nurse));
	}
	...
	public boolean addDepartment(Department department) {
		...
		return write(departments.put(department.getNumber(),department)==null);
	}
	
	public boolean addDisease(Disease disease) {
		return write(addMedicalProblem(disease));
	}
	...
	public boolean addFracture(Fracture fracture) {
		return write(addMedicalProblem(fracture));
	}
	
	public boolean addInjury(Injury injury) {
		return write(addMedicalProblem(injury));
	}
	...
	public boolean addMedication(Medication medication) {
		...
		return write(medications.put(medication.getCode(),medication)==null);
	}
	...
	public boolean addStaffMember(StaffMember staffMember) {
		...
		return write(staffMembers.put(staffMember.getId(),staffMember)==null);
	}
	...
	public boolean addPatient(Patient patient) {
		...
		return write(patients.put(patient.getId(),patient)==null);
	}
	...
	public boolean addTreatment(Treatment treatment) {
		...
		return write(treatments.put(treatment.getSerialNumber(),treatment)==null);
	}
	...
	public boolean addVisit(Visit visit) {
		...
		if(visit.getPatient().addVisit(visit))
			return write(visits.put(visit.getNumber(),visit)==null);
		return false;
	}
	...
	public boolean removeDepartment(Department department) {
		...
		return write(departments.remove(department.getNumber())!=null);
	}
	...
	public boolean removeMedicalProblem(MedicalProblem medicalProblem) {
		...
		return write(medicalProblems.remove(medicalProblem.getCode())!=null);
	}
	...
	public boolean removeMedication(Medication medication) {
		...
		return write(medications.remove(medication.getCode())!=null);
	}
	...
	public boolean removeStaffMember(StaffMember staffMember) {
		...
		for(Department d:staffMember.getDepartments()) {
			...
			if(d.getmanager()==(staffMember)) {
				d.setmanager(null);
			}
		}
		return write(staffMembers.remove(staffMember.getId()) != null);
	}
	...
	public boolean removePatient(Patient patient) {
		...
		return write(patients.remove(patient.getId()) != null);
	}
	...
	public boolean removeTreatment(Treatment treatment) {
		...
		return write(treatments.remove(treatment.getSerialNumber()) != null);
	}
	...
	public boolean removeVisit(Visit visit) {
		...
		return write(visits.remove(visit.getNumber()) != null);
	}
	...
	public int printHowManyFinishInternship() {
	...
	public HashMap<Department, HashMap<MedicalProblem, ArrayList<Treatment>>>getTreatmentsByMedicalProblemsByDepartment(){
		...
		for(MedicalProblem medicalProblem:medicalProblems.values()) {
			if (result.get(medicalProblem.getDepartment()) != null) {
	...
	public Doctor getOldestDoctor(Department department) {
		...
		for(StaffMember staffMember:department.getStaffMembersList()) {
			if(staffMember instanceof Doctor) {
				Doctor doctor=(Doctor) staffMember;
				System.out.println(doctor.getSpecialization() + ", " + doctor.isFinishInternship() + ", " + doctor.getWorkTime());
				System.out.println("Dept: " + department.getSpecialization());
	...
	public static void setInstance(Hospital hospital) {
		instance = hospital;
	}
