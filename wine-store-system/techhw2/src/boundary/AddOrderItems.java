...
public class AddOrderItems extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AddOrderItems(ManageOrders main) {
		...
		comboBox.setBounds(10, 14, 136, 27);
		...
		add_btn = new CustomButton("Edit",150,50,40);
		add_btn.setText("Add");
		add_btn.addActionListener(e -> addItem());
        add_btn.setBounds(486, 10, 113, 31);
        ...
        getContentPane().add(wbNumberDisplay);
	...
	private void addItem() {
		...
		Order order = ef.getOrdersTableModel().orders.get(rowIndex);
		int quantity = (Integer)spinner.getValue();

		boolean success = DatabaseController.addItem(order, bottle, quantity);
