...
public class ManageWineBottles extends JPanel {
	...
	public ManageWineBottles() {
        ...
        edit_btn.setBounds(510, 10, 89, 23);
        add(edit_btn);
        
        confirm_btn = new CustomButton("Edit", 150, 50, 40);
        confirm_btn.setText("Confirm");
        confirm_btn.setBounds(510, 11, 89, 23);
        confirm_btn.setVisible(false);
        confirm_btn.addActionListener(e -> confirmChanges());
        add(confirm_btn);
        
        CustomButton edit_btn_1 = new CustomButton("Edit", 150, 50, 40);
        edit_btn_1.setText("Delete");
        edit_btn_1.setBounds(510, 36, 89, 23);
        edit_btn_1.addActionListener(e -> deleteBottle());
        add(edit_btn_1);
	...
	private void enableEditting() {
        ...
        JOptionPane.showMessageDialog(null, 
                "You can now edit the WineBottle's details", 
                "Notify", 
	...
	private void confirmChanges() {
        ...
        JOptionPane.showMessageDialog(null, 
                "WineBottle details successfully changed!", 
                "Success", 
                JOptionPane.INFORMATION_MESSAGE);
	...
	private void deleteBottle() {
	    int response = JOptionPane.showConfirmDialog(null, 
	            "Are you sure you want to delete this wine bottle?", 
	            "Confirm Deletion", 
